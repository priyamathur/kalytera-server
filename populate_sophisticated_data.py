...
def load_data_to_agentiq(sessions, api_url):
    ...
    print(f"📊 Loading Sophisticated Agent Data to AgentIQ")
    print(f"🌐 API: {api_url}")
    print("=" * 60)
...
def main():
    ...
    for api_url in api_urls:
        ...
        try:
            ...
            if health.status_code == 200:
                print(f"✅ API healthy, proceeding with data load")
                ...
                if successful_loads > 0:
                    ...
                    if api_url == LOCAL_API:
                        ...
                        print(f"📊 Open Streamlit dashboard: http://localhost:8501")
                        print(f"🧠 View real LLM evaluations and pattern detection")
    ...
    print(f"🔗 Features now active:")
    print(f"   ✅ Multi-agent conversation analysis")
    print(f"   ✅ LLM-powered evaluation engine") 
    print(f"   ✅ Advanced pattern detection")
    print(f"   ✅ Real-time analytics dashboard")

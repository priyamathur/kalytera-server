...
def demonstrate_integrations():
    ...
    print(f"   User: I have a billing issue with my account")
    ...
    print(f"   User: I'm having payment problems")
    print(f"   System: {response2}")
    
    # Demo 3: Error Handling
    print("\n3. Error Tracking:")
    response3 = error_prone_agent("This is a complex query", "demo_session_3")
    print(f"   User: This is a complex query")
    print(f"   Agent: {response3}")
    
    print(f"\n✅ All interactions logged to AgentIQ!")
    print(f"📊 View analytics: https://agentiq-api-z9it.onrender.com/patterns/insights/top-intents")

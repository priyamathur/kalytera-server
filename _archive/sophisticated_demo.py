...
def show_real_agent_evaluations():
    ...
    print("📝 Evaluating Complex Customer Service Interaction:")
...
def show_fallback_evaluation(interaction):
    ...
    print("   🏷️  Category: customer_success (High satisfaction predicted)")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if endpoint == "/patterns/insights/top-intents":
                    ...
                    if top_intents:
                        print("   🔝 Top Intent Patterns:")
                        for intent in top_intents[:3]:
                            print(f"      - {intent}")
                    else:
                        print("   💡 Pattern Analysis: Processing recent data...")
...
def demonstrate_multi_agent_tracking():
    ...
    print("   ✅ Cross-agent handoff tracking")
    print("   ✅ Escalation pattern detection") 
    print("   ✅ Failure cascade analysis")
    print("   ✅ Success workflow identification")
    print("   ✅ Business impact correlation")

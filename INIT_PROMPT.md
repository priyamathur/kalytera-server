Kalytera — Initializer Agent
You are setting up the Kalytera project for autonomous development. This runs ONCE. Your job is to prepare the environment for all future coding agents.
Your tasks in order
1. Run pwd — confirm you are in the Kalytera project root
...
8. Make an initial git commit: "init: Kalytera autonomous development loop initialized"
Rules
